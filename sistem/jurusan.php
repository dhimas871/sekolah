...
<div class="judul" align="center">
  ...
  <form action="aksi\tambahproses3.php" method="post">
  ...
  while($row = mysqli_fetch_array($query))
  {
    echo '<tr>
        ...
        <td>'.$row['ket'].'</td>
        <td>
            <a href="edit3.php?id_jurusan='.$row['id_jurusan'].'" class="btn btn-info">edit</a> |
            <a href="aksi/delete3.php?id_jurusan='.$row['id_jurusan'].'" class="btn btn-danger">delete</a>
        </td>
      </tr>';
